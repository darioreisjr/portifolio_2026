  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "vscode-bg": "hsl(var(--vscode-bg))",
        "vscode-sidebar": "hsl(var(--vscode-sidebar))",
        "vscode-titlebar": "hsl(var(--vscode-titlebar))",
        "vscode-tab": "hsl(var(--vscode-tab))",
        "vscode-tab-active": "hsl(var(--vscode-tab-active))",
        "vscode-border": "hsl(var(--vscode-border))",
        "vscode-line-number": "hsl(var(--vscode-line-number))",
        "vscode-selection": "hsl(var(--vscode-selection))",
